...
import { GraduationCap, ArrowRight, BookOpen, Users, Award, ChevronDown } from "lucide-react"
...
export default function Home() {
  ...
  // Update the handleGetStarted function to show the new Find Course form
  const handleGetStarted = () => {
    // Show the new Find Course form
    setIsFormOpen(true)
  }
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-2 lg:gap-12">
              <div className="flex flex-col justify-center space-y-4 rounded-lg border p-6 shadow-sm">
                <div className="space-y-2">
                  <p className="text-gray-500 dark:text-gray-400">
                    ...
                    background. I'm now studying at my dream university!"
                  </p>
                  <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col justify-center space-y-4 rounded-lg border p-6 shadow-sm">
                <div className="space-y-2">
                  <p className="text-gray-500 dark:text-gray-400">
                    "I was unsure about which course to take after high school. EduPathway showed me options I hadn't
